      ...
      <List spacing={3} color='#444'>
        <ListItem>
          ...
          <Typography align='justify'>
            Los siguientes Términos y Condiciones son aplicables al acceso y uso
            del servicio del Marketplace (en adelante “Servicios”) administrado
            por Covende SAC (en adelante “Covende”) a través de la plataforma
            www.covende.com (en adelante “Sitio”), que permite a productores,
            fabricantes y/o importadores (en adelante “Vendedor”) mostrar sus
            productos (en adelante “producto(s)”) al usuario final (en adelante
            “Comprador”) y efectuar ventas bajo responsabilidad propia.
          </Typography>
          <br />
          <Typography align='justify'>
