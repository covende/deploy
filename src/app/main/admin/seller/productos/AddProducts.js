...
function AddProducts() {
  ...
  const findproduct = async (id) => {
    var store_id = await tienda(dispatch, product);
  ...
  const setTabIndex = (value) => {
    ...
    if (id && id != 'new')
      history.push('/seller/productos/update/' + id + '/step/' + value);
    else history.push('/seller/productos/create/new/step/' + value);
  };
  ...
  useEffect(() => {
    if (id && id != 'new')
      history.push('/seller/productos/update/' + id + '/step/' + tabIndex);
    else history.push('/seller/productos/create/new/step/' + tabIndex);
  }, [tabIndex]);
