...
import CancelarModal from '@CVPages/core/admin/buyer/pedidos/components/modales/CancelarModal';
...
function PedidoCancel({
  ...
  return (
    <CVModal
      ...
      <PedidoCancel
        {...{ idpedido, pedido, setsuccess, store_id }}
        isOpen={open}
        title='cancel'
